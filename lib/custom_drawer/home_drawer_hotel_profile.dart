...
class HomeDrawerHotelProfile extends StatefulWidget {
  const HomeDrawerHotelProfile({Key key, this.screenIndex, this.iconAnimationController, this.callBackIndex}) : super(key: key);

  final AnimationController iconAnimationController;
  final DrawerIndexHotelProfile screenIndex;
  final Function(DrawerIndexHotelProfile) callBackIndex;

  @override
  _HomeDrawerHotelProfileState createState() => _HomeDrawerHotelProfileState();
}

class _HomeDrawerHotelProfileState extends State<HomeDrawerHotelProfile> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndexHotelProfile.rate,
        labelName: 'FeedBack',
  ...
  Future<void> navigationtoScreen(DrawerIndexHotelProfile indexScreen) async {
    widget.callBackIndex(indexScreen);
  }
}

enum DrawerIndexHotelProfile {
  shops,
  userProfile,
  rate,
}
