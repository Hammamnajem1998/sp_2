...
import 'package:temp1/custom_drawer/home_drawer_Shops_profile.dart';
import 'package:flutter/material.dart';

class DrawerUserControllerShopslProfile extends StatefulWidget {
  const DrawerUserControllerShopslProfile({
    Key key,
  ...
  final Function(DrawerIndexShopsProfile) onDrawerCall;
...
class _DrawerUserControllerShopslProfileState extends State<DrawerUserControllerShopslProfile> with TickerProviderStateMixin {
