...
import 'package:temp1/custom_drawer/home_drawer_hotel_profile.dart';
import 'package:flutter/material.dart';

class DrawerUserControllerHotelProfile extends StatefulWidget {
  const DrawerUserControllerHotelProfile({
    Key key,
  ...
  final Function(DrawerIndexHotelProfile) onDrawerCall;
  final Widget screenView;
  final Function(bool) drawerIsOpen;
  final AnimatedIconData animatedIconData;
  final Widget menuView;
  final DrawerIndexHotelProfile screenIndex;

  @override
  _DrawerUserControllerHotelProfileState createState() => _DrawerUserControllerHotelProfileState();
}

class _DrawerUserControllerHotelProfileState extends State<DrawerUserControllerHotelProfile> with TickerProviderStateMixin {
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (BuildContext context, Widget child) {
                    return Transform(
                      ...
                      child: HomeDrawerHotelProfile(
                        screenIndex: widget.screenIndex == null ? DrawerIndexHotelProfile.shops : widget.screenIndex,
                        iconAnimationController: iconAnimationController,
                        callBackIndex: (DrawerIndexHotelProfile indexType) {
                          onDrawerClick();
                          try {
